...
The {\ttfamily{Paste Generator}} can be configures to produce randomly varying the values according to the configured parameters. In PowerDEVS IDE, the parameters dialogue box is for {\ttfamily{Paste Generator}} is shown in the Fig. \ref{fig:pastegen_params}.
